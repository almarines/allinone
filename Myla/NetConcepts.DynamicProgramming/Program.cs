...
namespace NetConcepts.DynamicProgramming
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var assembly = Assembly.LoadFile(@"C:\Users\mylaa\source\repos\AdvanceNetConcepts\Myla\NetConcepts.Model\bin\Debug\net5.0\NetConcepts.Model.dll");
            ...
            var mailService = Container.Resolve<IMailServce>();
