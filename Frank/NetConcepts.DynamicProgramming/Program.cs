    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            foreach (var companyType in assembly.GetTypes())
            {
                ...
                //Console.WriteLine($"Type of Training {companyType.FullName}");

                //// Instance Members
                //var trainingFields = companyType.GetFields(BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic);
                ...
                //var trainingMethods = companyType.GetMethods(BindingFlags.Instance | BindingFlags.Public);
                //Print(companyMethods, "Methods");
